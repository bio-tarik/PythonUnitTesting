...
class NewVisitorTest(StaticLiveServerTestCase):
    """
        To-Do list homepage test class
    """
    def setUp(self):
    ...
    def wait_for_row_in_list_table(self, row_text):
        """
            Keeps trying to find a DOM element until timeout (MAX_WAIT constant)
        """
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        """
            Enters the website, insert a register and then tries to retrieve it
        """
    ...
    def test_layout_and_styling(self):
        """
            Checks if the css style sheet is correctly loaded
        """
